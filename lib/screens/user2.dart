...
class _User2State extends State<User2> {
        ...
        child: Column(
          ...
          children: [
            ...
            GetBuilder<BalanceController>(
              builder: (_) => Text(
                balanceController.user2balance.toString(),
                style:
  ...
  topup_request(int amount) async {
    ...
    var response = await http.put(
      Uri.parse("https://ve8yx5.deta.dev/api/user/topup/2"),
...
//withdraw logic
  withdraw_request(int amount) async {
    ...
    var response = await http.put(
      Uri.parse("https://ve8yx5.deta.dev/api/user/withdraw/2"),
      body: jsonEncode(data),
      headers: _setHeaders(),
    );
    if (response.statusCode == 200) {
...
//sending logic
  send_request(int amount) async {
    ...
    var response = await http.put(
      Uri.parse("https://ve8yx5.deta.dev/api/user/send/2/1"),
      body: jsonEncode(data),
      headers: _setHeaders(),
    );
    if (response.statusCode == 200) {
